...
export function InquiryForm({ pilotOnly = false }: { pilotOnly?: boolean }) {
  ...
  return (
    <form className="inquiry-form" onSubmit={submit} noValidate>
      ...
      <label className="check-row"><Checkbox checked={termsAccepted} onCheckedChange={(value) => setTermsAccepted(value === true)} /><span>I agree to the <Link href="/terms" target="_blank">Terms of Use</Link> and understand this is not a clinical submission channel.</span></label>
